...
# =============================================
# Modelo de clasificación (idéntico a train.py)
# =============================================
class EmotionClassifier(nn.Module):
    def __init__(self, num_classes):
        super(EmotionClassifier, self).__init__()
        
        # Capas convolucionales (misma arquitectura que en entrenamiento)
...
def evaluate_model(model, X_test, y_test):
    ...
    plt.bar(EMOTIONS, [class_acc[e] for e in EMOTIONS], color='skyblue')
    ...
    for i, emotion in enumerate(EMOTIONS):
        plt.text(i, class_acc[emotion] + 2, f"{class_counts[emotion]} muestras", 
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\nSolución: Asegúrate de usar el mismo modelo definido en train.py")
        exit(1)
